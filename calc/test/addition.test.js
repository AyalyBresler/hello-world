...
describe('ADDITION', ()=>{
    ...
    it('should return a number to string of 2 number in the add operator twice', () => {
        let calc = new Calc('2++3')
        let result = calc.calc()
        expect(result).toBe(5)
    })
    ...
    it('should return a number to string of 2 numbers in the add operator after the multiplication operator',()=>{
        let calc = new Calc('2*+3')
        let result = calc.calc()
        expect(result).toBe(5)
    })
