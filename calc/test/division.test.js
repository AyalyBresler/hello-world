...
describe('DIVISION', ()=>{
    ...
    it('should return a number to string of 2 number in the division operator twice', ()=>{
        let calc = new Calc('6//3')
        let result = calc.calc()
        expect(result).toBe(2)
    })
    it('should return a number to string of 2 numbers in the sub operator after division operator', () => {
        let calc = new Calc('6-/3')
        let result = calc.calc()
        expect(result).toBe(2)
    })
    it('should return a number to string of 2 numbers in the division operator after the add operator', () => {
        let calc = new Calc('6+/3')
        let result = calc.calc()
        expect(result).toBe(2)
    })
    ...
    it('should return a number to string of 2 numbers in the division operator after the multi operator', ()=>{
        let calc = new Calc('6*/3')
        let result = calc.calc()
        expect(result).toBe(2)
    })
    ...
    describe('ERROR',()=>{
        ...
        it('should throw error when send one number is 0 and operator division',()=>{
            let calc = new Calc('6/0')
            expect(() => calc.calc()).toThrow('not valid')
        })
    })
})